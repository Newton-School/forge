...
export const openapiDocument = {
  ...
  tags: [
    ...
    { name: "Org", description: "Domains & teams (scope-filtered)" },
  ...
  paths: {
    ...
    "/org/domains": { get: { tags: ["Org"], summary: "Domains in scope", responses: { "200": { description: "Domains" } } } },
    "/org/teams": { get: { tags: ["Org"], summary: "Teams in scope", responses: { "200": { description: "Teams" } } } },
