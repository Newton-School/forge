...
import { submit, type MockDomain, type MockTeam, type MockTemplate } from "@/lib/api";
...
/**
 * Email compose + targeting form. Presentational: the domain/team option lists and the
 * saved templates are fetched and passed in by the server page.
 */
  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
        ...
        <div className="flex flex-col gap-6">
          <SectionCard title="Templates" description={`${templates.length} saved`} bodyClassName="flex flex-col divide-y divide-border">
            {templates.map((t) => (
