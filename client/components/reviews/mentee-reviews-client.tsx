...
import type { MockUpdate, MockWeeklyReview } from "@/lib/api";
import { shortDate } from "@/lib/utils";

/**
 * Interactive mentee reviews UI (tabs + submit form). Presentational: the data is fetched
 * and scoped to the signed-in mentee by the server page, then passed in.
 */
export function MenteeReviewsClient({
  updates,
  reviews,
}: {
  updates: MockUpdate[];
  ...
  return (
    <Tabs defaultValue="submit">
      ...
      <TabsContent value="my-updates">
        <SectionCard title="My Updates" description={`${updates.length} submitted`}>
          <Table>
            <TableHeader>
              <TableRow>
