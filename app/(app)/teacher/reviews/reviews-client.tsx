...
import type { MockWeeklyReview } from "@/lib/mock/data";
                      ...
                      {r.teacherDecision === null ? (
                        ...
                        >
                          ...
                          <Field label="Teacher notes" htmlFor="l4-notes">
                            <Textarea id="l4-notes" rows={4} placeholder="Notes on this week's review" />
                          </Field>
                        </FormDialog>
                      ) : (
                ...
                <div className="flex shrink-0 items-center gap-2">
                  ...
                  >
                    <Field label="Feedback" htmlFor="revise-feedback" hint="24h resubmission window">
                      <Textarea id="revise-feedback" rows={4} placeholder="What needs to change before resubmission?" />
                    </Field>
                  </FormDialog>
                  <ConfirmDialog
